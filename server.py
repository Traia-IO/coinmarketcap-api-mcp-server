...
**Plan credit use:** 0 credit
    ...
    Args:
        ...
        news_type: Optionally specify a comma-separated list of supplemental data fields: `news`, `community`, or `alexandria` to filter news sources. Pass `all` or leave it blank to include all news types. (optional, default: "all")
        content_type: Optionally specify a comma-separated list of supplemental data fields: `news`, `video`, or `audio` to filter news's content. Pass `all` or leave it blank to include all content types. (optional, default: "all")
        category: Optionally pass a comma-separated list of categories. Example: "GameFi,NFT". (optional)
        language: Optionally pass a language code. Example: "en". If not specified the default value is "en". (optional, default: "en")
    ...
    try:
        ...
        logger.error(f"Error in Content Latest: {e}")
...
async def Metadata v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
**CMC equivalent pages:** Cryptocurrency detail page metadata like [coinmarketcap.com/currencies/bitcoin/](https://coinmarketcap.com/currencies/bitcoin/).  
    ...
    Example Usage:
        # Minimal (required params only):
        await Metadata v1 (deprecated)()

        # With optional parameters:
        await Metadata v1 (deprecated)(skip_invalid=False, aux="urls,logo,description,tags,platform,date_added,notice")
    ...
    try:
        ...
        logger.error(f"Error in Metadata v1 (deprecated): {e}")
...
async def CoinMarketCap ID Map(
    context: Context,
...
**CMC equivalent pages:** No equivalent, this data is only available via API.
    ...
    try:
        ...
        logger.error(f"Error in CoinMarketCap ID Map: {e}")
...
async def Exchange Assets(
  ...
  **CMC equivalent pages:** Exchange detail page like [coinmarketcap.com/exchanges/binance/](https://coinmarketcap.com/exchanges/binance/)
    ...
    try:
        ...
        logger.error(f"Error in Exchange Assets: {e}")
...
**CMC equivalent pages:** Exchange detail page metadata like [coinmarketcap.com/exchanges/binance/](https://coinmarketcap.com/exchanges/binance/).  
    ...
    Example Usage:
        ...
        # With optional parameters:
        await Metadata(aux="urls,logo,description,date_launched,notice")
...
async def Postman Conversion v1(
    context: Context
) -> Dict[str, Any]:
    """
    Convert APIs into postman format. You can reference the operation from <a href="https://coinmarketcap.com/alexandria/article/register-for-coinmarketcap-api" target="_blank"><b>this article</b></a>.
  ...
  **Technical Notes**
  - Set the env variables in the postman: {{baseUrl}}, {{API_KEY}}
    ...
    try:
        ...
        logger.error(f"Error in Postman Conversion v1: {e}")
...
async def Price Conversion v1 (deprecated)(
    context: Context,
...
**CMC equivalent pages:** Our cryptocurrency conversion page at [coinmarketcap.com/converter/](https://coinmarketcap.com/converter/).  
    ...
    Example Usage:
        await Price Conversion v1 (deprecated)(amount=None)
    ...
    try:
        ...
        logger.error(f"Error in Price Conversion v1 (deprecated): {e}")
...
**CMC equivalent pages:** Cryptocurrency detail page metadata like [coinmarketcap.com/currencies/bitcoin/](https://coinmarketcap.com/currencies/bitcoin/).  
    ...
    Example Usage:
        ...
        # With optional parameters:
        await Metadata v2(skip_invalid=False, aux="urls,logo,description,tags,platform,date_added,notice")
    ...
    try:
        ...
        logger.error(f"Error in Metadata v2: {e}")
...
**CMC equivalent pages:** Our cryptocurrency conversion page at [coinmarketcap.com/converter/](https://coinmarketcap.com/converter/).  
    ...
    Example Usage:
        await Price Conversion v2(amount=None)
    ...
    try:
        ...
        logger.error(f"Error in Price Conversion v2: {e}")
...
async def CMC Crypto Fear and Greed Historical(
    context: Context,
    start: int = 1,
    limit: int = 50
) -> Dict[str, Any]:
...
**CMC equivalent pages:** Our CMC Crypto Fear and Greed Index card on https://coinmarketcap.com/charts/.
    ...
    Example Usage:
        # Minimal (required params only):
        await CMC Crypto Fear and Greed Historical()

        # With optional parameters:
        await CMC Crypto Fear and Greed Historical(start=1, limit=50)
    ...
    try:
        ...
        logger.error(f"Error in CMC Crypto Fear and Greed Historical: {e}")
...
async def CMC Crypto Fear and Greed Latest(
    context: Context
) -> Dict[str, Any]:
    """
...
**CMC equivalent pages:** Our CMC Crypto Fear and Greed Index card on https://coinmarketcap.com/charts/.
    ...
    Example Usage:
        await CMC Crypto Fear and Greed Latest()
    """
    # Payment already verified by @require_payment_for_tool decorator
    # Get API key using helper (handles request.state fallback)
    api_key = get_active_api_key(context)
    ...
    try:
        ...
        logger.error(f"Error in CMC Crypto Fear and Greed Latest: {e}")
...
**CMC equivalent pages:** Our blockchain explorer pages like [blockchain.coinmarketcap.com/](https://blockchain.coinmarketcap.com/).
    ...
    try:
        ...
        logger.error(f"Error in Statistics Latest: {e}")
...
async def Community Trending Tokens(
    context: Context,
    limit: int = 5
) -> Dict[str, Any]:
    """
...
**Plan credit use:** 0 credit
    ...
    Args:
        context: MCP context (auto-injected by framework, not user-provided)
        limit: Optionally specify the number of results to return. (optional, default: 5)
    ...
    Example Usage:
        # Minimal (required params only):
        await Community Trending Tokens()

        # With optional parameters:
        await Community Trending Tokens(limit=5)
    ...
    try:
        ...
        logger.error(f"Error in Community Trending Tokens: {e}")
...
async def Community Trending Topics(
    context: Context,
    limit: int = 5
) -> Dict[str, Any]:
    """
...
**Plan credit use:** 0 credit
    ...
    Example Usage:
        # Minimal (required params only):
        await Community Trending Topics()

        # With optional parameters:
        await Community Trending Topics(limit=5)
    ...
    try:
        ...
        logger.error(f"Error in Community Trending Topics: {e}")
...
async def Content Post Comments(
    context: Context,
...
**Plan credit use:** 0 credit
    ...
    Example Usage:
        await Content Post Comments(post_id="example")
    ...
    try:
        ...
        logger.error(f"Error in Content Post Comments: {e}")
...
async def Content Latest Posts(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
**Plan credit use:** 0 credit
    ...
    try:
        ...
        logger.error(f"Error in Content Latest Posts: {e}")
...
**Plan credit use:** 0 credit
    ...
    try:
        ...
        logger.error(f"Error in Content Top Posts: {e}")
...
**CMC equivalent pages:** Our historical daily crypto ranking snapshot pages like this one on [February 02, 2014](https://coinmarketcap.com/historical/20140202/).
    ...
    Example Usage:
        # Minimal (required params only):
        await Listings Historical(date="example")

        # With optional parameters:
        await Listings Historical(
        date="example",
        start=1,
        limit=100,
        sort="cmc_rank"
    ...
    try:
        ...
        logger.error(f"Error in Listings Historical: {e}")
...
***NOTE:** Use this endpoint if you need a sorted and paginated list of all cryptocurrencies. If you want to query for market data on a few specific cryptocurrencies use [/v1/cryptocurrency/quotes/latest](#operation/getV1CryptocurrencyQuotesLatest) which is optimized for that purpose. The response data between these endpoints is otherwise the same.* 
    ...
    try:
        ...
        logger.error(f"Error in Listings Latest: {e}")
...
***NOTE:** Use this endpoint if you need a sorted and paginated list of all recently added cryptocurrencies.* 
    ...
    Example Usage:
        ...
        # With optional parameters:
        await Listings New(start=1, limit=100)
    ...
    try:
        ...
        logger.error(f"Error in Listings New: {e}")
...
async def Market Pairs Latest v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
**CMC equivalent pages:** Our active cryptocurrency markets pages like [coinmarketcap.com/currencies/bitcoin/#markets](https://coinmarketcap.com/currencies/bitcoin/#markets).  
    ...
    Example Usage:
        # Minimal (required params only):
        await Market Pairs Latest v1 (deprecated)()
    ...
    try:
        ...
        logger.error(f"Error in Market Pairs Latest v1 (deprecated): {e}")
...
async def OHLCV Historical v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
**CMC equivalent pages:** Our historical cryptocurrency data pages like [coinmarketcap.com/currencies/bitcoin/historical-data/](https://coinmarketcap.com/currencies/bitcoin/historical-data/).
    ...
    Example Usage:
        # Minimal (required params only):
        await OHLCV Historical v1 (deprecated)()
    ...
    try:
        ...
        logger.error(f"Error in OHLCV Historical v1 (deprecated): {e}")
...
async def OHLCV Latest v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    symbol: Optional[str] = None,
    convert: Optional[str] = None,
  ...
  **CMC equivalent pages:** No equivalent, this data is only available via API.
    ...
    Example Usage:
        # Minimal (required params only):
        await OHLCV Latest v1 (deprecated)()

        # With optional parameters:
        await OHLCV Latest v1 (deprecated)(skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in OHLCV Latest v1 (deprecated): {e}")
...
async def Price Performance Stats v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
***NOTE:** You may also use [/cryptocurrency/ohlcv/historical](#operation/getV1CryptocurrencyOhlcvHistorical) for traditional OHLCV data at historical daily and hourly intervals. You may also use [/v1/cryptocurrency/ohlcv/latest](#operation/getV1CryptocurrencyOhlcvLatest) for OHLCV data for the current UTC day.* 
    ...
    Example Usage:
        # Minimal (required params only):
        await Price Performance Stats v1 (deprecated)()

        # With optional parameters:
        await Price Performance Stats v1 (deprecated)(time_period="all_time", skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in Price Performance Stats v1 (deprecated): {e}")
...
async def Quotes Historical v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    symbol: Optional[str] = None,
    time_start: Optional[str] = None,
...
**CMC equivalent pages:** Our historical cryptocurrency charts like [coinmarketcap.com/currencies/bitcoin/#charts](https://coinmarketcap.com/currencies/bitcoin/#charts).  
    ...
    Example Usage:
        # Minimal (required params only):
        await Quotes Historical v1 (deprecated)()
    ...
    try:
        ...
        logger.error(f"Error in Quotes Historical v1 (deprecated): {e}")
...
async def Quotes Latest v1 (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
***NOTE:** Use this endpoint to request the latest quote for specific cryptocurrencies. If you need to request all cryptocurrencies use [/v1/cryptocurrency/listings/latest](#operation/getV1CryptocurrencyListingsLatest) which is optimized for that purpose. The response data between these endpoints is otherwise the same.*
    ...
    Example Usage:
        # Minimal (required params only):
        await Quotes Latest v1 (deprecated)()

        # With optional parameters:
        await Quotes Latest v1 (deprecated)(aux="num_market_pairs,cmc_rank,date_added,tags,platform,max_supply,circulating_supply,total_supply,is_active,is_fiat", skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in Quotes Latest v1 (deprecated): {e}")
...
async def Trending Gainers & Losers(
    context: Context,
    start: int = 1,
    limit: int = 100,
    time_period: str = "24h",
...
**CMC equivalent pages:** Our cryptocurrency Gainers & Losers page [coinmarketcap.com/gainers-losers/](https://coinmarketcap.com/gainers-losers/).
    ...
    try:
        ...
        logger.error(f"Error in Trending Gainers & Losers: {e}")
...
**CMC equivalent pages:** Our cryptocurrency Trending page [coinmarketcap.com/trending-cryptocurrencies/](https://coinmarketcap.com/trending-cryptocurrencies/).
    ...
    try:
        ...
        logger.error(f"Error in Trending Latest: {e}")
...
async def Trending Most Visited(
    context: Context,
    start: int = 1,
    limit: int = 100,
    time_period: str = "24h",
...
**CMC equivalent pages:** The CoinMarketCap “Most Visited” trending list. [coinmarketcap.com/most-viewed-pages/](https://coinmarketcap.com/most-viewed-pages/).
    ...
    try:
        ...
        logger.error(f"Error in Trending Most Visited: {e}")
...
*After this date, the "exchange_score" field return null from these endpoints. We encourage users to review and update their implementations accordingly to avoid any disruptions.*
    ...
    Args:
        ...
        start: Optionally offset the start (1-based index) of the paginated list of items to return. (optional, default: 1)
        limit: Optionally specify the number of results to return. Use this parameter and the "start" parameter to determine your own pagination size. (optional, default: 100)
        sort: What field to sort the list of exchanges by. (optional, default: "volume_24h")
        sort_dir: The direction in which to order exchanges against the specified sort. (optional)
        market_type: The type of exchange markets to include in rankings. This field is deprecated. Please use "all" for accurate sorting. (optional, default: "all")
        category: The category for this exchange. (optional, default: "all")
...
**CMC equivalent pages:** Our exchange level active markets pages like [coinmarketcap.com/exchanges/binance/](https://coinmarketcap.com/exchanges/binance/).  
    ...
    Example Usage:
        # Minimal (required params only):
        await Market Pairs Latest()

        # With optional parameters:
        await Market Pairs Latest(
        start=1,
        limit=100,
        aux="num_market_pairs,category,fee_type"
    )
    ...
    try:
        ...
        logger.error(f"Error in Market Pairs Latest: {e}")
...
**CMC equivalent pages:** No equivalent, this data is only available via API outside of our volume sparkline charts in [coinmarketcap.com/rankings/exchanges/](https://coinmarketcap.com/rankings/exchanges/).  
    ...
    Example Usage:
        # Minimal (required params only):
        await Quotes Historical()

        # With optional parameters:
        await Quotes Historical(count=10, interval="5m")
    ...
    try:
        ...
        logger.error(f"Error in Quotes Historical: {e}")
...
*After this date, the "exchange_score" field return null from these endpoints. We encourage users to review and update their implementations accordingly to avoid any disruptions.*
    ...
    Example Usage:
        ...
        # With optional parameters:
        await Quotes Latest(aux="num_market_pairs,traffic_score,rank,exchange_score,liquidity_score,effective_liquidity_24h")
    ...
    try:
        ...
        logger.error(f"Error in Quotes Latest: {e}")
...
async def Market Pairs Latest v2(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
**CMC equivalent pages:** Our active cryptocurrency markets pages like [coinmarketcap.com/currencies/bitcoin/#markets](https://coinmarketcap.com/currencies/bitcoin/#markets).  
    ...
    try:
        ...
        logger.error(f"Error in Market Pairs Latest v2: {e}")
...
**CMC equivalent pages:** Our historical cryptocurrency data pages like [coinmarketcap.com/currencies/bitcoin/historical-data/](https://coinmarketcap.com/currencies/bitcoin/historical-data/).
    ...
    try:
        ...
        logger.error(f"Error in OHLCV Historical v2: {e}")
...
**Please note**: This documentation relates to our updated V2 endpoint, which may be incompatible with our V1 versions. Documentation for deprecated endpoints can be found <a href="#tag/deprecated">here</a>.<br><br>
  ...
  **CMC equivalent pages:** No equivalent, this data is only available via API.
    ...
    Example Usage:
        # Minimal (required params only):
        await OHLCV Latest v2()

        # With optional parameters:
        await OHLCV Latest v2(skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in OHLCV Latest v2: {e}")
...
async def Price Performance Stats v2(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
***NOTE:** You may also use [/cryptocurrency/ohlcv/historical](#operation/getV1CryptocurrencyOhlcvHistorical) for traditional OHLCV data at historical daily and hourly intervals. You may also use [/v1/cryptocurrency/ohlcv/latest](#operation/getV1CryptocurrencyOhlcvLatest) for OHLCV data for the current UTC day.* 
    ...
    Example Usage:
        # Minimal (required params only):
        await Price Performance Stats v2()

        # With optional parameters:
        await Price Performance Stats v2(time_period="all_time", skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in Price Performance Stats v2: {e}")
...
async def Quotes Historical v2(
    context: Context,
    id: Optional[str] = None,
    symbol: Optional[str] = None,
    time_start: Optional[str] = None,
...
**CMC equivalent pages:** Our historical cryptocurrency charts like [coinmarketcap.com/currencies/bitcoin/#charts](https://coinmarketcap.com/currencies/bitcoin/#charts).  
    ...
    try:
        ...
        logger.error(f"Error in Quotes Historical v2: {e}")
...
***NOTE:** Use this endpoint to request the latest quote for specific cryptocurrencies. If you need to request all cryptocurrencies use [/v1/cryptocurrency/listings/latest](#operation/getV1CryptocurrencyListingsLatest) which is optimized for that purpose. The response data between these endpoints is otherwise the same.*
    ...
    Example Usage:
        # Minimal (required params only):
        await Quotes Latest v2()

        # With optional parameters:
        await Quotes Latest v2(aux="num_market_pairs,cmc_rank,date_added,tags,platform,max_supply,circulating_supply,total_supply,is_active,is_fiat", skip_invalid=True)
    ...
    try:
        ...
        logger.error(f"Error in Quotes Latest v2: {e}")
...
async def Quotes Historical v3(
    context: Context,
    id: Optional[str] = None,
    symbol: Optional[str] = None,
    time_start: Optional[str] = None,
...
**Please note**: This documentation relates to our updated V3 endpoint, which may be incompatible with our V1 versions. Documentation for deprecated endpoints can be found <a href="#tag/deprecated">here</a>.<br><br>
**Technical Notes**  
- A historic quote for every "interval" period between your "time_start" and "time_end" will be returned.  
- If a "time_start" is not supplied, the "interval" will be applied in reverse from "time_end".  
- If "time_end" is not supplied, it defaults to the current time.  
...
**CMC equivalent pages:** Our historical cryptocurrency charts like [coinmarketcap.com/currencies/bitcoin/#charts](https://coinmarketcap.com/currencies/bitcoin/#charts).  
    ...
    try:
        ...
        logger.error(f"Error in Quotes Historical v3: {e}")
...
async def FCAS Listings Latest (deprecated)(
    context: Context,
    start: int = 1,
    limit: int = 100,
...
***NOTE:** Use this endpoint to request the latest FCAS score for all supported cryptocurrencies at the same time. If you require FCAS for only specific cryptocurrencies use [/v1/partners/flipside-crypto/fcas/quotes/latest](#operation/getV1PartnersFlipsidecryptoFcasQuotesLatest) which is optimized for that purpose. The response data between these endpoints is otherwise the same.* 
    ...
    Example Usage:
        # Minimal (required params only):
        await FCAS Listings Latest (deprecated)()
    ...
    try:
        ...
        logger.error(f"Error in FCAS Listings Latest (deprecated): {e}")
...
async def FCAS Quotes Latest (deprecated)(
    context: Context,
    id: Optional[str] = None,
    slug: Optional[str] = None,
    symbol: Optional[str] = None,
...
***NOTE:** Use this endpoint to request the latest FCAS score for specific cryptocurrencies. If you require FCAS for all supported cryptocurrencies use [/v1/partners/flipside-crypto/fcas/listings/latest](#operation/getV1PartnersFlipsidecryptoFcasListingsLatest) which is optimized for that purpose. The response data between these endpoints is otherwise the same.*
    ...
    Example Usage:
        # Minimal (required params only):
        await FCAS Quotes Latest (deprecated)()

        # With optional parameters:
        await FCAS Quotes Latest (deprecated)(aux="point_change_24h,percent_change_24h")
    ...
    try:
        ...
        logger.error(f"Error in FCAS Quotes Latest (deprecated): {e}")
